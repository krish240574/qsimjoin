...
ip:{$[33=c;rukip;];$[1<y;[s:sum each (f0[c]-/:f0 z)xexp 2;i:iasc s;s:asc s];[s:sum (f0[c]-f0 z)xexp 2;i:0]]; (h x):@[h x;c;:;enlist ($[1<y;z i;z];s)]; }
/ Get nearest neighbours
gnn:{$[33=c;rukgnn;];$[0h=type .k.ep;.k.ep:.k.ep 0;];rc:count r:(raze over  (h x).k.ep);rc:count r:r til rc div 2;r:$[1=rc;r 0;r]; ip[x;rc;r];	}
/ Helper functions
